...
//ema arr
double 50ema = iMA(_Symbol,_Period,50,0,MODE_EMA,0,0);
...
if(signal == "buy" && OrdersTotal()==0)
  {
   OrderSend(_Symbol,OP_BUY,0.10,Bid,3,stoploss,Bid+500*_Point,"Buy Taken",0,0,Red);
  }
  
if(signal == "sell" && OrdersTotal()==0)
  {
   OrderSend(_Symbol,OP_SELL,0.10,Bid,3,stoploss,Bid-500*_Point,"Sell Taken",0,0,Red);
  }
