...
//---
  ...
  /* AutoTrade settings*/
 double lotSize = 0.10; // define lot size
 ...
 double TP_sell = close_price-25*SymbolInfoDouble(_Symbol,SYMBOL_POINT);
...
if(signal == "buy" && OrdersTotal()==0)
  {
  OrderSend(_Symbol,OP_BUY,lotSize,Bid,3,SL,TP,"Sell Taken",0,0,Red);
   //OrderSend(_Symbol,OP_BUY,0.10,Bid,3,SL,TP,"Buy Taken",0,0,Red);
